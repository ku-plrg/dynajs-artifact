...
```bash
# for ESMeta
export DYNAJS_EXTRACTOR_HOME="<path to ESMeta>" # IMPORTANT!!!
export PATH="$DYNAJS_EXTRACTOR_HOME/bin:$PATH" # for executables `esmeta` and etc.
source $DYNAJS_EXTRACTOR_HOME/.completion # for auto-completion
```
...
- `-test262dir={string}` sets the directory of Test262 (default: `$DYNAJS_EXTRACTOR_HOME/tests/test262`).
